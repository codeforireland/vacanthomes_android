...
//    public void setLayout(int layoutId, int stepperId){
//        Log.d(TAG, "setLayout ID: "+layoutId);
//        this.layoutId=layoutId;
//        this.stepperLayout = findViewById(stepperId);
//    }
//R.layout.activity_main_new, R.id.stepperLayout
        @Override
